...
const jsonLd = computed(() => ({
  ...
  image: `${siteUrl}${piece.value!.social_image}`,
...
useHead(() => ({
  ...
  meta: [
    ...
    { property: 'og:image', content: `${siteUrl}${piece.value!.social_image}` },
    { property: 'og:image:type', content: 'image/png' },
    { property: 'og:image:width', content: '1200' },
    { property: 'og:image:height', content: '630' },
    { property: 'og:image:alt', content: `${piece.value!.citation_title} interactive figure` },
    ...
    { name: 'twitter:image', content: `${siteUrl}${piece.value!.social_image}` },
    { name: 'twitter:image:alt', content: `${piece.value!.citation_title} interactive figure` },
  ],
